...
import { FaAppleAlt, FaLaptop, FaPills, FaPumpSoap, FaSignOutAlt, FaChartPie, FaUtensils  } from "react-icons/fa";
  ...
  return (
    <div className="sidebar">
      ...
      <div className="menu">
        ...
        <div 
          className={`menu-item1 ${active === "Cleaning" ? "active" : ""}`} 
          onClick={() => handleNavigation("Cleaning", "/cleaning")}
        >
          <FaPumpSoap className="icon" /> Cleaning Supplies
        </div>
